...
from restaurant.forms import ReservationForm, ReservationAdminForm
from restaurant.models import Table, Worker, Reservation
from restaurant.services import send_reservation_notification, round_time_to_next_slot
...
class ReservationListView(LoginRequiredMixin, ListView):
    ...
    def get_queryset(self):
        ...
        # Сортировка по дате, времени и номеру столика
...
class WorkerListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['kitchen'] = sorted(context['kitchen'],
                                    key=lambda w: (w.position != Worker.the_chef, w.position != Worker.sous_chef))
