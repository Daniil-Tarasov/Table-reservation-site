...
class Reservation(models.Model):
    ...
    owner = models.ForeignKey(User, on_delete=models.SET_NULL, verbose_name='Гость', blank=True, null=True, related_name='reservation')
...
class Worker(models.Model):
    ...
    avatar = ImageCropField(upload_to='restaurant/workers/images', verbose_name='Фото сотрудника', blank=True, null=True)
